...
/**
 * Contexto de plantilla compartido por los fragmentos visuales de Gestión de Usuarios.
 * Usa las mismas instancias provistas por la page contenedora; no crea estado ni
 * duplica reglas de negocio.
 */
export abstract class UserManagementTemplateContext {
    protected readonly accountOperations = inject(UserAccountOperationsController);
    protected readonly filterState = inject(UserManagementFilterState);
    protected readonly filterPresenter = inject(UserManagementFilterPresenter);
    protected readonly filterController = inject(UserManagementFilterController);
    protected readonly state = inject(UserManagementPageState);
    protected readonly presenter = inject(UserManagementPagePresenter);
    protected readonly data = inject(UserManagementDataController);
