...
import { UserRegistrationNotificationService, StructureEmailCatalogs } from '../services/user-registration-notification.service';
...
import { UserRegistrationDraftContext, UserRegistrationDraftCoordinator } from '../coordinators/user-registration-draft.coordinator';
import { UserRegistrationProfileContext, UserRegistrationProfileController } from '../controllers/user-registration-profile.controller';
import { UserRegistrationStructureContext } from '../controllers/user-registration-structure.controller';
import { UserRegistrationCatalogCoordinator, UserRegistrationCatalogState } from '../catalogs/user-registration-catalog.coordinator';
import { UserRegistrationSubmissionContext } from '../coordinators/user-registration-submission.coordinator';
import { UserRegistrationValidationCoordinator, UserRegistrationValidationState } from '../coordinators/user-registration-validation.coordinator';
import { UserRegistrationValidationContext, UserRegistrationValidator } from '../validators/user-registration.validator';
