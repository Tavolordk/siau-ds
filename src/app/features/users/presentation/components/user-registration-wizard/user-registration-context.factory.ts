...
import { UserRegistrationNotificationService, StructureEmailCatalogs } from './user-registration-notification.service';
...
import { UserRegistrationDraftContext, UserRegistrationDraftCoordinator } from './user-registration-draft.coordinator';
import { UserRegistrationProfileContext, UserRegistrationProfileController } from './user-registration-profile.controller';
import { UserRegistrationStructureContext } from './user-registration-structure.controller';
import { UserRegistrationCatalogCoordinator, UserRegistrationCatalogState } from './user-registration-catalog.coordinator';
import { UserRegistrationSubmissionContext } from './user-registration-submission.coordinator';
import { UserRegistrationValidationCoordinator, UserRegistrationValidationState } from './user-registration-validation.coordinator';
import { UserRegistrationValidationContext, UserRegistrationValidator } from './user-registration.validator';
