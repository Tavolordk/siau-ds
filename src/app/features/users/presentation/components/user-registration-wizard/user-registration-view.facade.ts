...
import { UserRegistrationNavigationActions, UserRegistrationNavigationController } from './user-registration-navigation.controller';
...
import { UserRegistrationSubmissionCoordinator } from './user-registration-submission.coordinator';
import {
    ALL_WIZARD_STEPS,
    AccountStatus,
